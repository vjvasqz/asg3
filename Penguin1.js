class Penguin {
    ...
    // renderHands(rightArmMatrix, leftArmMatrix) {
    //     // Right hand
    //     var rightHand = new Cube();
    //     rightHand.color = this.bottomBeakColor;
    //     var rightHandMatrix = new Matrix4(rightArmMatrix);
    //     rightHandMatrix.translate(0.0, 1, 0.005);
    //     rightHandMatrix.rotate(-115, 0, 0, 1);
    //     rightHandMatrix.scale(1, 0.5, 1);
    //     rightHand.matrix = rightHandMatrix;
    //     rightHand.render();

    //     // Left hand
    //     var leftHand = new Cube();
    //     leftHand.color = this.bottomBeakColor;
    //     var leftHandMatrix = new Matrix4(leftArmMatrix);
    //     leftHandMatrix.translate(0.0, 0.48, 0.005);
    //     leftHandMatrix.rotate(-15, 0, 0, 1);
    //     leftHandMatrix.scale(1, 0.17, 1);
